...
def build_dataset_train(dataset, input_size, batch_size, train_type, random_scale, random_mirror, num_workers):
    data_dir = os.path.join('/home/zhuxx/LETNet/Network/dataset/', dataset)
    ...
    inform_data_file = os.path.join('/home/zhuxx/LETNet/Network/dataset/inform/', dataset + '_inform.pkl')
